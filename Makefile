...
d2f.json: ~/quicklisp/local-projects/d2fb/boot/das2json/helloworld.drawio
	(cd ~/quicklisp/local-projects/d2fb/boot/das2json ; make helloworld.json)
	cp ~/quicklisp/local-projects/d2fb/boot/das2json/helloworld.drawio ./d2f.drawio
	cp ~/quicklisp/local-projects/d2fb/boot/das2json/helloworld.json ./d2f.json
